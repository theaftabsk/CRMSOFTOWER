    ...
    <div className="min-h-screen bg-[#F8F8F8] flex items-center justify-center p-4">
      <div className="bg-white border border-[#E5E5E5] rounded-xl max-w-sm w-full p-6 space-y-6 shadow-[0_1px_3px_rgba(0,0,0,0.02)]">
        <div className="text-center space-y-1">
          ...
          <h1 className="text-lg font-bold text-[#111111] tracking-tight">Reset Password</h1>
          <p className="text-xs text-[#666666]">Enter your email to receive recovery link</p>
        </div>
